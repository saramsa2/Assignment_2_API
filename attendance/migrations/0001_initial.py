# Generated by Django 4.1.3 on 2022-11-11 01:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('theClass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='attendance.class')),
            ],
        ),
        migrations.AddField(
            model_name='class',
        ...
        migrations.AddField(
            model_name='class',
            name='student',
            field=models.ManyToManyField(blank=True, to='attendance.student', verbose_name='enrolled student'),
        ),
    ]
